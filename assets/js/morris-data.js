...
$(function() {
    ...
    if($('#morris_area_chart').length > 0)
		...
		Morris.Area({
			...
			lineWidth:0,
			fillOpacity: 1,
			pointStrokeColors:['#71aa68', '#ed8739', '#e6b034'],
			behaveLikeLine: true,
			grid: false,
			hideHover: 'auto',
			lineColors: ['#71aa68', '#ed8739', '#e6b034'],
			resize: true,
			redraw: true,
			smooth: true,
    ...
    if($('#morris_donut_chart').length > 0) {
		...
		Morris.Donut({
			...
			colors: ['rgba(113,170,104,1)', 'rgba(230,176,52,1)', 'rgba(218,71,58,1)'],
			resize: true,
			labelColor: '#878787',
		});
	...
	if($('#morris_extra_line_chart').length > 0)
        ...
        fillOpacity: 0,
		lineWidth:2,
		pointStrokeColors:['#71aa68', '#e6b034', '#f33923'],
		behaveLikeLine: true,
		grid: false,
		hideHover: 'auto',
		lineColors: ['#71aa68', '#e6b034', '#f33923'],
		resize: true,
		gridTextColor:'#878787',
		gridTextFamily:"Roboto"
	...
	if($('#morris_extra_bar_chart').length > 0)
		...
		Morris.Bar({
			...
			ykeys: ['a', 'b', 'c'],
			labels: ['A', 'B', 'C'],
			barColors:['#71aa68', '#e6b034', '#f33923'],
			barOpacity:1,
			hideHover: 'auto',
			grid: false,
			resize: true,
